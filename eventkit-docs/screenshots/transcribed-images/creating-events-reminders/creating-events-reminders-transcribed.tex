...
\noindent\fbox{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}
        ...
        If you pass NO to the \texttt{commit} parameter, make sure that you later invoke the \texttt{commit()} method to permanently save your changes.
    \end{minipage}}
...
\noindent\fbox{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}
        ...
        If your iOS app links on macOS and you need to access Reminders data, be sure to include the \texttt{NSRemindersUsageDescription} key in your Info.plist file.
    \end{minipage}}
...
\noindent\fbox{\begin{minipage}{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}
        ...
        Just like when saving or removing events, make sure that if you pass NO to the \texttt{commit} parameter, you later invoke the \texttt{commit()} method to save your changes.
    \end{minipage}}
