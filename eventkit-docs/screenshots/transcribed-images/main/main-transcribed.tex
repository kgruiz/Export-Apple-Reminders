...
\includegraphics[width=0.3in]{placeholder} Accessing the event store
...
\includegraphics[width=0.3in]{placeholder} Accessing Calendar using \texttt{EventKit} and \texttt{EventKitUI}

Choose and implement the appropriate Calendar access level in your app.

\textbf{Events and reminders}

\includegraphics[width=0.3in]{placeholder} Creating events and reminders

Create and modify events and reminders in a person's database.

\includegraphics[width=0.3in]{placeholder} Retrieving events and reminders

Fetch events and reminders from the Calendar database.

\includegraphics[width=0.3in]{placeholder} Updating with notifications

Register for notifications about changes and keep your app up to date.

\includegraphics[width=0.3in]{placeholder} Managing Location-Based Reminders
...
\includegraphics[width=0.3in]{placeholder} Creating a recurring event
...
\includegraphics[width=0.3in]{placeholder} Setting an alarm
